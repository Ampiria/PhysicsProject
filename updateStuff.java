...
public class updateStuff extends TimerTask {
    public void run() {
        MainScreen.insideTemperature = MainScreen.sidePanel.walltempslide.getValue()-(MainScreen.wall1.materialType.thermalConductivity*MainScreen.sidePanel.outsidetempslide.getValue()-MainScreen.wall1.materialType.thermalConductivity*MainScreen.sidePanel.walltempslide.getValue())/MainScreen.wall2.materialType.thermalConductivity;
